...
export const getAdminSidebarLinks = (onLogout: () => void): SidebarLink[] => [
  {
    label: "Dashboard",
    href: "/admin/dashboard",
    icon: (
      <svg
        className="h-5 w-5 shrink-0 text-saveful-green"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
      >
  ...
  },
  {
    ...
    icon: (
      <svg
        className="h-5 w-5 shrink-0 text-saveful-orange"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
      >
  ...
  },
  {
    ...
    icon: (
      <svg
        className="h-5 w-5 shrink-0 text-saveful-purple"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
      >
  ...
  },
  {
    ...
    children: [
      {
        label: "Flexible Recipe Categories",
        href: "/admin/framework-categories",
        icon: (
          <svg
  ...
  },
  {
    ...
    icon: (
      <svg
        className="h-5 w-5 shrink-0 text-saveful-pink"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
      >
  ...
  },
  {
    ...
    icon: (
      <svg
        className="h-5 w-5 shrink-0 text-saveful-gray"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
      >
...
export const getChefSidebarLinks = (onLogout: () => void): SidebarLink[] => [
  {
    label: "Dashboard",
    href: "/chef/dashboard",
    icon: (
