...
export function AuthLoginForm({ config }: { config: LoginFormConfig }) {
  ...
  // â”€â”€ Login submit â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Forgot password submit â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Shared card header â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const CardHeader = () => (
    <>
      ...
      {view === "login" && (
        <>
          ...
          <form className="space-y-6" onSubmit={handleLoginSubmit}>
            ...
            <button
              className={cn(
                "group/btn relative block h-12 w-full rounded-xl bg-gradient-to-r font-semibold text-white shadow-lg transition-all duration-300 hover:scale-[1.02] hover:shadow-xl disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:scale-100",
                roleGradient
              )}
              type="submit"
              disabled={isLoading}
          ...
          <form className="space-y-6" onSubmit={handleForgotSubmit}>
            ...
            <div className="text-center">
              <button
                ...
                className="inline-flex items-center gap-1.5 text-sm font-medium text-[#6B6B6B] transition-colors hover:text-[#2D5F4F]"
              >
                <svg
                  className="h-4 w-4"
                  fill="none"
      ...
      {view === "forgot-success" && (
        <div className="py-4 text-center">
          ...
          <p className="mb-1 text-sm text-[#6B6B6B]">
            If <span className="font-medium text-[#1a1a1a]">{forgotEmail}</span>{" "}
          ...
          <button
            ...
            className={cn(
              "group/btn relative inline-flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r font-semibold text-white shadow-lg transition-all duration-300 hover:scale-[1.02] hover:shadow-xl",
              roleGradient
            )}
          >
            <svg
